...
def create_graph(llm):
    ...
    def call_llm(state: AgentState) -> dict:
        ...
        if verbose:
            print(f"[TRACE] Entering node: call_llm | verbose={verbose}")
        ...
        if verbose:
            print(f"[TRACE] call_llm sending prompt: {prompt!r}")
    ...
    def print_response(state: AgentState) -> dict:
        ...
        if verbose:
            print(f"[TRACE] Entering node: print_response | verbose={verbose}")
        ...
        if verbose:
            print(f"[TRACE] print_response complete, routing back to get_user_input")
    ...
    graph_builder.add_conditional_edges(
        ...
        route_after_input,      # Routing function that examines state
        {
            ...
            "get_user_input": "get_user_input",  # verbose/quiet toggle -> re-prompt
